module EA_Extensions623
  ...
  unless file_loaded? (__FILE__)
    ...
    cmd = UI::Command.new("Rolled") {
     Sketchup.active_model.select_tool @two = EASteelTools::RolledDialog.new
    }
    @@EA_tools_menu.add_item cmd
    cmd.small_icon = "icons/wfs_icon_rolled.png"
    cmd.large_icon = "icons/wfs_icon_rolled.png"
    cmd.tooltip = "Draw Rolled Wide Flange Steel"
    cmd.status_bar_text = "Draw Rolled Steel"
    cmd.menu_text = "Wide Rolled Flange Steel"
    toolbar = toolbar.add_item cmd
    toolbar.show
