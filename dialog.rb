  ...
  module EASteelTools
    ...
    class Window
      ...
      def initialize
        ...
        options = {
          :title           => "Wide Flange Steel - Version #{VERSION_NUM}",
          :preferences_key => 'WFS',
          :width           => 400,
          :height          => 360,
          :resizable       => false
        ...
        group2 = SKUI::Groupbox.new( 'Profile View (Not Finished)' )
